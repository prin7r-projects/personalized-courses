/**
 * [READING_LIST_NOWPAYMENTS_CHECKOUT] POST /api/checkout/nowpayments
 *
 * Body:    { plan: "single" | "subscription" | "coached" }
      ...
      return NextResponse.json(
        {
          ...
          message:
            "Crypto checkout is not configured on this deployment yet. Email tutor@personalized-courses.prin7r.com and we'll hand-wire the invoice."
        },
        { status: 503 }
      );
    }
